...
//  HAL_Delay(1000);
//  set_pid_target(&g_pid_speed1,100);
//  set_pid_target(&g_pid_speed2,100);
...
//      sprintf((char *)oledstring,"motor1:%d",g_unittime_motor1pluse);//显示单位时间脉冲数
...
//      
//      sprintf((char *)oledstring,"motor2:%d",g_unittime_motor2pluse);//显示单位时间脉冲数
