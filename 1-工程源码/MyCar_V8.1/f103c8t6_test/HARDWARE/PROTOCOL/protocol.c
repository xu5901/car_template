  ...
  while(1)
  {
    ...
    switch (cmd_type)
    {
      ...
      case SET_P_I_D_CMD:
      {
        ...
        /*要调那个PID就取消哪个注释*/
//        set_p_i_d(&g_pid_speed1, p_temp, i_temp, d_temp);    // 设置那个改那个，只能通过通道观察
//        set_p_i_d(&g_pid_location1, p_temp, i_temp, d_temp);
//        set_p_i_d(&g_pid_speed2, p_temp, i_temp, d_temp); 
//        set_p_i_d(&g_pid_location2, p_temp, i_temp, d_temp);    // 设置那个改那个，只能通过通道观察
        set_p_i_d(&g_pid_turn_angle,p_temp, i_temp, d_temp);
      ...
      case SET_TARGET_CMD:
      {
        ...
        set_point = actual_temp;
          ...
          /*要调哪个PID就取消哪个注释*/
//        set_pid_target(&g_pid_speed1, set_point);   
//        set_pid_target(&g_pid_location1, set_point);
//        set_pid_target(&g_pid_speed2, set_point);   
//        set_pid_target(&g_pid_location2, set_point);
        set_pid_target(&g_pid_turn_angle, set_point);
      }
      break;
